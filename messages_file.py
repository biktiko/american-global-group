MESSAGES = {
    ...
    "share_phone": {
        "hy": "Կցանկանա՞ք առաջինն իմանալ մեր հատուկ առաջարկների և զեղչերի մասին: 😊 Թողեք Ձեր հեռախոսահամարը, և մենք կտեղեկացնենք Ձեզ ամենահետաքրքիր նորությունները:",
        "en": "Would you like to be the first to know about our special offers and discounts? 😊 Leave your phone number, and we'll keep you updated with all our exciting news!"
    },
    "share": {
        "hy": "📲 Կիսվել",
        "en": "📲 Share"
    ...
    "route_names": {
        "Air AM to USA": {
            "hy": "Օդային առաքում Հայաստանից ԱՄՆ",
            "en": "Air Shipments from Armenia to the USA"
        },
        "Air USA to AM": {
            "hy": "Օդային առաքում ԱՄՆ-ից Հայաստան",
            "en": "Air Shipments from the USA to Armenia"
        },
        "Ocean USA to AM": {
            "hy": "Ծովային առաքում ԱՄՆ-ից Հայաստան",
            "en": "Ocean shipments from the USA to Armenia"
        },
        "unknown": {
            "hy": "Հասկանալի ուղղություն չի գտնվել",
            "en": "Unknown direction"
        }
    },
    "where_to_find_button": {
        "hy": "📍 Որտե՞ղ փնտրել",
        "en": "📍 Where to Find"
    },
    "change_direction": {
        "hy": "Փոխել ուղղությունը",
        "en": "Change a direction"
    },
    "selected_direction": {
        "hy": "Ընտրած ուղղություն՝ ",
